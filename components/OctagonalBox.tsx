    ...
    <>
      <div className={`relative flex flex-row ${boxClassName}`}>
        <div className={`relative z-10 w-6 ${smallBoxClassName}`}>
          ...
          <div className={`absolute top-0 left-0 w-0 border-transparent ${smallTriangleWidth} ${borderSmallTriangleColor} border-b-transparent border-r-transparent`} />
          <div className={`absolute bottom-0 left-0 w-0 border-transparent ${bigTriangleWidth} border-b-black border-l-black`} />
          <div className={`absolute bottom-0 left-0 w-0 border-transparent ${smallTriangleWidth} ${borderSmallTriangleColor} border-t-transparent border-r-transparent`} />
        ...
        <div className={`relative z-10 w-6 ${smallBoxClassName}`}>
          ...
          <div className={`absolute top-0 right-0 w-0 border-transparent ${smallTriangleWidth} ${borderSmallTriangleColor} border-b-transparent border-l-transparent`} />
          <div className={`absolute bottom-0 right-0 w-0 border-transparent ${bigTriangleWidth} border-b-black border-r-black`} />
          <div className={`absolute bottom-0 right-0 w-0 border-transparent ${smallTriangleWidth} ${borderSmallTriangleColor} border-t-transparent border-l-transparent`} />
