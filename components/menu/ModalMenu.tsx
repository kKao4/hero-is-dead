...
export default function ModalMenu({ isOpenResponsiveMenu }: { isOpenResponsiveMenu: boolean }) {
  return (
    <div className={`${isOpenResponsiveMenu ? "opacity-100 translate-y-0 z-10" : "opacity-0 -translate-y-[100%] -z-10"} transition-all duration-400 fixed top-0 w-full ease-out h-screen py-18 bg-root-white z-40`}>
