  ...
  return (
    <div className={`${isOpenResponsiveMenu ? "opacity-100 translate-y-0 z-10" : "opacity-0 -translate-y-[10%] -z-10"} transition-all duration-400 fixed top-0 w-full h-screen py-14 bg-root-white`}>
      ...
      <div className="flex flex-col py-10 gap-y-6">
        ...
        <MenuLink title_1="On Air" title_2="Phát Sóng" mobile={true} />
        <MenuLink title_1="Story" title_2="Cốt Truyện" mobile={true} />
        <MenuLink title_1="STAFF&CAST" title_2="Nhân viên và diễn viên" mobile={true} />
        <MenuLink title_1="CHARACTER" title_2="Nhân Vật" mobile={true} />
        <MenuLink title_1="PRODUCT" title_2="Sản Phẩm" mobile={true} />
        <MenuLink title_1="SPECIAL" title_2="Đặc Biệt" mobile={true} />
        <MenuLink title_1="TWITTER" title_2="TWITTER" mobile={true} />
      </div>
    </div>
  )
}