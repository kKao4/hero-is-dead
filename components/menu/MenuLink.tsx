...
export default function MenuLink({ title_1, title_2, mobile, href }: { title_1: string, title_2: string, mobile: boolean, href: string }) {
  return (
    <Link href={href} className={`${mobile ? "mx-auto" : ""} flex flex-row items-center group gap-x-2`}>
